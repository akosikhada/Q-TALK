...
interface CallsPermissionModalProps {
  visible: boolean;
  onClose: () => void;
...
const CallsPermissionModal: React.FC<CallsPermissionModalProps> = ({
  visible,
  onClose,
  onSelect,
  currentValue,
  ...
  const options = [
    ...
    },
    {
      value: "contacts",
      title: "Contacts Only",
      description: "Only your contacts can call you",
      icon: "user-check",
    },
    {
      value: "nobody",
...
export default CallsPermissionModal;
