...
interface GroupAddPermissionModalProps {
  visible: boolean;
  onClose: () => void;
...
const GroupAddPermissionModal: React.FC<GroupAddPermissionModalProps> = ({
  visible,
  onClose,
  onSelect,
  currentValue,
  ...
  const options = [
    ...
    },
    {
      value: "contacts",
      title: "Contacts Only",
      description: "Only your contacts can add you to groups",
      icon: "user-check",
    },
    {
      value: "nobody",
      title: "Nobody",
      description: "No one can add you to groups",
      icon: "user-x",
    },
  ];
...
export default GroupAddPermissionModal;
